...
typedef std::function<void(void)> OpenThermInterruptCallback;
typedef std::function<void(unsigned long, OpenThermResponseStatus)> OpenThermProcessResponseCallback;
...
public:
	...
	void begin(OpenThermInterruptCallback handleInterruptCallback);
	void begin(OpenThermInterruptCallback handleInterruptCallback, OpenThermProcessResponseCallback OpenThermProcessResponseCallback);
	bool isReady();
...
private:
	...
	OpenThermInterruptCallback handleInterruptCallback;
	OpenThermProcessResponseCallback processResponseCallback;

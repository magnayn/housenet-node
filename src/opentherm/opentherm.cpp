...
void OpenTherm::begin(OpenThermInterruptCallback handleInterruptCallback, OpenThermProcessResponseCallback OpenThermProcessResponseCallback)
{
    std::function<void(void)> cb = handleInterruptCallback;
...
void OpenTherm::begin(OpenThermInterruptCallback handleInterruptCallback)
{
